...
import ru.otus.exchange.generator.kafka.KafkaSenderImpl;
...
public class KafkaSenderConfiguration {
    ...
    public KafkaSender kafkaSender(
            GeneratorProperties generatorProperties, KafkaTemplate<UUID, KafkaMessage> kafkaTemplate) {
        return new KafkaSenderImpl(generatorProperties, kafkaTemplate);
    }
}
